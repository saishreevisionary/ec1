...
const CATEGORY_ITEMS = {
  1: [ // Essential Oils (27 items + Cardamom = 28)
  ...
  2: [ // Spice Oils (27 items + Ginger = 28)
  ...
  3: [ // Spice Oleoresins (27 items + Black Pepper 40/20 = 28)
  ...
  4: [ // Floral Concretes (27 items + Jasmine Grandiflorum = 28)
  ...
  5: [ // Floral Absolutes (27 items + Tuberose = 28)
  ...
  6: [ // Spice Powders (27 items + Turmeric = 28)
...
console.log("Category items counts:");
for (const catId of [1, 2, 3, 4, 5, 6]) {
  console.log(`Cat ${catId}: ${CATEGORY_ITEMS[catId].length} items (+ 1 featured = 28)`);
}
